      ...
      ws.onmessage = (event) => {
        ...
        if (data.type === 'external_alert') {
          data.alerts?.forEach((a: any) => {
            setLiveUpdates(prev => [`${a.message}`, ...prev.slice(0, 4)]);
          });
        }
      };
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-lg shadow p-4">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-75">Αίσθηση: {Math.round(externalData.weather.feels_like)}°C</p>
          ...
          {externalData?.earthquakes && (
            <div className="bg-white rounded-lg shadow p-4">
              <h3 className="font-bold text-gray-800 mb-3">
                🌍 Σεισμοί (7 μέρες)
                <span className="ml-2 text-sm font-normal text-gray-400">{externalData.earthquakes.total} συνολικά</span>
              </h3>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">{externalData.traffic.incidents?.length || 0} περιστατικά</p>
                </div>
              </div>
            </div>
          )}
